...
class TitanFrameworkOptionSelectServices extends TitanFrameworkOption {
	...
	public function registerCustomizerControl( $wp_customize, $section, $priority = 1 ) {
		$wp_customize->add_control( new TitanFrameworkOptionSelectServicesControl( $wp_customize, $this->getID(), array(
 ...
 */
add_action( 'customize_register', 'registerTitanFrameworkOptionSelectServicesControl', 1 );
function registerTitanFrameworkOptionSelectServicesControl() {
	class TitanFrameworkOptionSelectServicesControl extends WP_Customize_Control {
		public $description;
		public $post_type;
		public $num;
		public $post_status;
